...
public:
	...
	void ARect(RECT arect) { this->arect = arect; rect.setLeft(arect.left / zoom), rect.setTop(arect.top / zoom), rect.setRight(arect.right / zoom), rect.setBottom(arect.bottom / zoom); }
