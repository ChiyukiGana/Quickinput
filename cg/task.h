...
namespace CG
{
    ...
    public:
        ...
        static const TaskStruct Register(std::wstring taskName, std::wstring exePath = Process::exePath(), std::wstring runPath = Path::RemoveFile(Process::exePath()), std::wstring author = L"unknow")
        {
            TaskStruct ts;
